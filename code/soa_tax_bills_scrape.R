...
soa_list <- list()
  ...
  for(i in 1:nrow(bbls)){
    bbl <- na_bbls2[i]
    soa_list[i] <- paste0('https://a836-edms.nyc.gov/dctm-rest/repositories/dofedmspts/StatementSearch?bbl=', bbl, '&stmtDate=20210604&stmtType=SOA')
  }
